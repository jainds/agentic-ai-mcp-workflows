...
kubectl port-forward -n insurance-ai-poc service/insurance-ai-poc-streamlit-ui 8501:80 &

echo "🤖 Starting Domain Agent on port 8003..."
kubectl port-forward -n insurance-ai-poc service/insurance-ai-poc-domain-agent 8003:8003 &

echo "⚙️ Starting Technical Agent on port 8002..."
kubectl port-forward -n insurance-ai-poc service/insurance-ai-poc-technical-agent 8002:8002 &

echo "📋 Starting Policy Server on port 8001..."
kubectl port-forward -n insurance-ai-poc service/insurance-ai-poc-policy-server 8001:8001 &

echo "📊 Starting Monitoring on port 8080..."
kubectl port-forward -n insurance-ai-poc service/insurance-ai-poc-monitoring 8080:8080 &
